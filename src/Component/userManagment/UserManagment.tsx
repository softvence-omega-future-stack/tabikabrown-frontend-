...
const UserManagement: React.FC = () => {
    ...
    <div className="min-h-screen ">
      <div className=" bg-white rounded-2xl border border-gray-400 overflow-hidden">
        ...
        <div className=" p-2.5 md:p-6 ">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 leading-[120%] mb-6">User Management</h1>
                  ...
                  <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex flex-col">
                        <span className=" text-base font-normal font-inter  text-gray-900 leading-6 mb-1">{user.name}</span>
  ...
  <path d="M3.41663 14.084H7.41663" stroke="#0372E6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <td className="py-4 px-4">
                      <span className={`inline-block px-4 py-2 rounded-full text-sm font-medium leading-[130%] ${
                        user.status === 'Active' 
